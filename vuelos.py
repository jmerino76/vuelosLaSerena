...
"logo_url": "[https://google.com](https://google.com)",
...
for tabla in soup.find_all("table"):
    ...
    for fila in tabla.find_all("tr"):
        ...
        if len(celdas) >= 6:
            ...
            if is_sky:
                logo_url = "https://raw.githubusercontent.com/jmerino76/vuelosLaSerena/main/SKY.jpg"
                aerolinea = f'<img src="{logo_url}" width="70" alt="Sky">'
                vuelo_num = f"H2 {digitos}"
                aerolinea_raw_text = "Sky"
            elif is_jetsmart:
                logo_url = "https://raw.githubusercontent.com/jmerino76/vuelosLaSerena/main/JetSmart.jpg"
                aerolinea = f'<img src="{logo_url}" width="70" alt="JetSmart">'
                vuelo_num = f"JA {digitos}"
                aerolinea_raw_text = "JetSmart"
            elif is_latam:
                logo_url = "https://raw.githubusercontent.com/jmerino76/vuelosLaSerena/main/LATAM.jpg"
                aerolinea = f'<img src="{logo_url}" width="70" alt="LATAM">'
                vuelo_num = f"LA {digitos}"
                aerolinea_raw_text = "LATAM"
            else:

# Caso alternativo: Si no es ninguna de las tres grandes, usa el texto alternativo de la imagen o un valor genérico
